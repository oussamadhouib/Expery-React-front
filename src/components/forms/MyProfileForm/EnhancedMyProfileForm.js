...
export const EnhancedMyProfileForm = compose(
  ...
  withFormik({
    mapPropsToValues: props => ({ name: props.profile.username, email: props.profile.email }),
    ...
    handleSubmit: (  values,  { props, setSubmitting, resetForm } ) => {
      ApiService.editMyProfile(props.profile._id, {email: values.email,  username: values.username}).then(payload=>{
        setSubmitting(false)
